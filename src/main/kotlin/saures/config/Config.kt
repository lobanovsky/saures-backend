    ...
    companion object {
        fun fromEnvironment(): Config {
            ...
            return Config(
                email       = email,
                password    = password,
                dbUrl       = System.getenv("SAURES_DB_URL")      ?: "jdbc:postgresql://localhost:5456/saures",
                dbUser      = System.getenv("SAURES_DB_USER")     ?: "saures",
                dbPassword  = System.getenv("SAURES_DB_PASSWORD") ?: "saures",
